...
<body>
											...
											<div class="col-md-12 col-xl-6">
												<div class="card add-task-card">
													<div class="card-header">
														...
														<div class="card-header-right">
															<button class="btn btn-card btn-primary">ADD
																TASK</button>
														</div>
													</div>
													...
													<c:choose>
														...
														<div class="to-do-list">
															<div class="checkbox-fade fade-in-primary d-block " style = "height:100px;">
														...
														<!-- <div class="to-do-list">
															<div class="checkbox-fade fade-in-primary d-block">
																...
																</span> <span><h6>Meeting With HOD's and borad</h6>
																...
																<label class="check-task d-block"> <input
																	type="checkbox" value=""> <span class="cr">
																		...
																		class="cr-icon icofont icofont-ui-check txt-default"></i>
																			...
																			Create template, admin with responsive<span
																				class="label bg-c-pink m-l-10">2 week</span>
																		</h6></span>
																...
																<label class="check-task d-block"> <input
																	...
																	<div class="task-card-img m-l-40">
																		<a href="#!"><img
																			...
																			class="img-40"></a> <a href="#!"><img
																			src="/resources/assets/images/avatar-3.jpg"
																			data-toggle="tooltip" title="Alia" alt=""
																			class="img-40 m-l-10"></a> <a href="#!"><img
																			src="/resources/assets/images/avatar-2.jpg"
																			data-toggle="tooltip" title="Josephin Doe" alt=""
																			class="img-40 m-l-10"></a>
																	</div>
																</label>
															</div>
														</div> -->
	...
	<!-- var $window = $(window); var nav = $('.fixed-button');
	$window.scroll(function(){ if ($window.scrollTop() >= 200) {
	nav.addClass('active'); } else { nav.removeClass('active'); } }); -->
