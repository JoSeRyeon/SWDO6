                                        ...
                                        <!-- <div class="row">  -->
						                     <div style="text-align: center;"> 
												<h1><div id = "demo"  style = "font-size : 200px; font-weight : bolder;">00분00초</div></h1>
													<div>
														<button class="btn btn-danger btn-round" onclick = "timer50();" id="timer50">50분 타이머</button>
														<button class="btn btn-primary btn-round" onclick = "timer25();" id ="timer25">25분 타이머</button>
													</div><br>
													<div>
														<button class="btn btn-primary btn-round" onclick = "timerStart();">학습 시작</button>
														<button class="btn btn-danger btn-round" onclick = "timerStop();" id = "timeStop">학습 종료</button>
													</div>
												</div> 
											</div>		
										</div>
